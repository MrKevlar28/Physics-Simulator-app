...
from fileRun import (basicSimulator,cameraSimulator,planetSimulator,playgroundSimulator,pendulumSimulator,halfoutwoodMacSimulator,outwoodMacSimulator)
...
class BoxLayoutExample(BoxLayout):
    ...
    def onButton3_press(self, instance):
        playgroundSimulator()
    
    def onButton4_press(self, instance):
        halfoutwoodMacSimulator()
        outwoodMacSimulator()
